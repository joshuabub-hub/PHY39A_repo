...
This is due to various effects; the heat generated by the TEC is given by:

$$Q_h = S_m T_h I + 0.5 I^2 R_m - K_m (T_h - T_c)$$
The first term is the intended effect of the 
